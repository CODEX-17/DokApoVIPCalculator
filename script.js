document.addEventListener("DOMContentLoaded", () => {
  ...
  btn.addEventListener("click", () => {
    ...
    const data = [
      {
        ...
        price: parseInt(document.getElementById("lotionBig").value * 130),
        remit: 110,
      },
      {
      ...
      },
      {
        ...
        price: parseInt(document.getElementById("lemonRub").value * 40),
        remit: 25,
      },
      {
        name: "Coco Milk Soap",
        quantity: document.getElementById("milkSoap").value,
        price: parseInt(document.getElementById("milkSoap").value * 40),
        remit: 25,
      },
      {
      ...
      },
      {
        ...
        price: parseInt(document.getElementById("detox").value * 210),
        remit: 190,
      },
      {
        name: "Melter Capsule",
        quantity: document.getElementById("melter").value,
        price: parseInt(document.getElementById("melter").value * 210),
        remit: 190,
      },
      {
        name: "Better Vision",
        quantity: document.getElementById("betterVision").value,
        price: parseInt(document.getElementById("betterVision").value * 210),
        remit: 190,
      },
      {
        name: "AX5 Capsule",
        quantity: document.getElementById("ax5").value,
        price: parseInt(document.getElementById("ax5").value * 210),
        remit: 190,
      },
      {
        name: "Pro kidney Capsule",
        quantity: document.getElementById("proKidney").value,
        price: parseInt(document.getElementById("proKidney").value * 210),
        remit: 190,
      },
      {
        name: "Vitamin C Plus",
        quantity: document.getElementById("vitC").value,
        price: parseInt(document.getElementById("vitC").value * 210),
        remit: 190,
      },
      {
        name: "Barley Capsule",
        quantity: document.getElementById("barley").value,
        price: parseInt(document.getElementById("barley").value * 210),
        remit: 190,
      },
    ];
    ...
    profit = totalPrice + 1000 - remittance;
